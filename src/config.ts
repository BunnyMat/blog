...
export const SITE = "https://bunnymat.github.io";
...
export const SITE_TITLE = "Matin's blog";
...
export const SITE_FAVICON = "/blog/favicon.ico";
...
export const BLUESKY_IDENTIFIER = "bunnymat";
